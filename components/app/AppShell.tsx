...
import { api, clearToken, getToken, QUOTA_EVENT } from "@/lib/api";
...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <OrgContext.Provider value={{ org, refreshOrg, showUpgrade }}>
      <div className="min-h-screen">
        ...
        <main className="pt-20 pb-16 px-6 max-w-6xl mx-auto">{children}</main>
